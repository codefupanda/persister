...
import com.codefupanda.persistor.Persistor;

/**
 * Templates basically wrap ORMs and provide a uniform API for accessing
 * SQL database and NoSql collections .
 * Different Templates for different Databases types.
 * 
 * @author Shashank Kulkarni (shashank.physics (@) gmail.com)
 */
public interface Template extends Persistor {
	
	// Methods extended from Persistor
}
